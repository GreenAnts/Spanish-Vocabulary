...
**Goal:** Enable the user to learn the basic and necessary words that would likely be taught in a "Spanish 101" class. These words will not necessarily be frequency based, but should be words one would be expected to learn when first encountering a language.
